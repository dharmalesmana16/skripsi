...
<div class="row mb-3">
	...
	<div class="col-sm-10">
    <input type="text" class="form-control" name="device_name" id="device_name" placeholder="Enter Your Device Name (e.g : DEVICE001 )" value="<?= $dataDevice['nama_device'] ?>">
	</div>
</div>
	...
	<div class="row mb-3">
        ...
        <option selected value="<?= $dataDevice['brand'] ?>"><?= $dataDevice['brand'] ?></option>
...
<div class="row mb-3">
        ...
        <option selected value="<?= $dataDevice['tipekoneksi'] ?>"><?= $dataDevice['tipekoneksi'] ?></option>
 ...
 <div class="row mb-3">
		...
		<div class="col-sm-10">
			<input type="text" id="mac" name="mac" class="form-control" placeholder="Enter your Device Mac Address"  value="<?= $dataDevice['mac'] ?>" required />
		</div>
	</div>
 <div class="row mb-3">
		<label for="ip" class="col-sm-2 col-form-label" >IP Address</label>
		<div class="col-sm-10">
			<input type="text" id="ip" name="ip" class="form-control" placeholder="Enter your Device IP Address (If Exist)" value="<?= $dataDevice['ipaddress'] ?>" required />
		</div>
	</div>
	...
	<div class="row mb-3 form-group">
	  ...
	  <label for="latitude">Latitude</label>
        ...
        <input type="text" class="form-control" id="latitude" name="latitude" value="<?= $dataDevice['latitude'] ?>" >
      </div>
	  <br>
	
      <div class="col-sm-6">
		  <label for="longitude">Longitude</label>
        <input type="text" class="form-control" id="longitude" name="longitude" value="<?= $dataDevice['longitude'] ?>">
      </div>
    </div>
    <div class="text-end">

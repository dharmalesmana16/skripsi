...
<html lang="en">
  ...
  <body>
    ...
    <aside class="sidebar-nav-wrapper overflow-hidden ">
      ...
      <nav class="sidebar-nav" >
        ...
        <li class="nav-item menus <?php if($title == "Controlling | Smart PJU") echo 'active';?>">
            <a href="{{  url('/controls') }} " class="menu2">
              <span class="icon">
    ...
    <li class="nav-item nav-item-has-children">
            ...
            $resLamps = DB::table('lamps')->select(["nama_lampu","meta"])->get()->toArray();

            foreach ($resLamps as $lamps):
            ?>
              <li>
                <a href="{{  url('/monitoringlamp' . '/' . $lamps->nama_lampu )}}"> {{ $lamps->nama_lampu }} </a>
              </li>
              <?php endforeach ?>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse dropdown-nav">
                <?php
                $resDevices = DB::table('devices')->select(["nama_device","meta"])->get()->toArray();

                foreach ($resDevices as $devices):
                ?>
              <li>
                <a href="{{ url('/monitoring' . '/' . $devices->nama_device )}}"> {{ $devices->nama_device }} </a>
            </li>
              <?php endforeach ?>
            </ul>
          </li>

                    ...
                    <div class="card-body">
                        <form action="<?=base_url('/device')?>" method="post" id="datadevices" class="createdevice">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="device_brand" id="device_brand" class="form-control"
                ...
                <div class="col-sm-10">
                        <input type="text" class="form-control" name="model_device" id="model_device" placeholder="Enter your Device Model (e.g:v1 / v2 / v3)" >
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="device_connectivity" id="device_connectivity" class="form-control"
                                        aria-label="Default select example">
                                        <option selected value="-">-</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" id="mac" name="mac" class="form-control"
                                        placeholder="Enter your Device Mac Address" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="ip" name="ip" class="form-control"
                                        placeholder="Enter your Device IP Address (If Exist)" required />
                                </div>
                            </div>

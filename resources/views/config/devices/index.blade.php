...
<div class="card-style">
    ...
    <a class="main-btn primary-btn btn-hover createdevice btn-sm fw-bold mb-20 rounded-md" href="/devices/new"
        role="button">Create New Data +</a>
                        ...
                        <div class="d-flex">
                            <div class="action">
                                <button class="btn text-primary">
                                    <a href="/devices/update/{{ $dataDevices['meta'] }}">
                                        <i class="fa fa-wrench"></i>
                                    </a>
                                </button>
                            </div>
                            <form action="/devices/show/{{ $dataDevices['meta'] }}" method="GET"
                                class="d-inline btnshow">
                            ...
                            <form action="/devices/{{ $dataDevices['meta'] }}" method="POST"
                                class="d-inline deletedevice">
                                <input type="hidden" name="_method" value="DELETE">
                                <div class="action">
